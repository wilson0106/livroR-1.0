...
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/setwd.png')
```
...
```{r ctrl-shift-h, message = FALSE, echo = FALSE, fig.cap = "**[Inserir PRINT da janela ctrl shift h]**", fig.align = "center", out.width = '60%'}
...
```{r mode-2, message = FALSE, echo = FALSE, fig.cap = "**[Inserir PRINT da janela session]**", fig.align = "center", out.width = '60%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/files.png')
```

```{r files-guia, message = FALSE, echo = FALSE, fig.cap = "**[Inserir PRINT da janela files-guia]**", fig.align = "center", out.width = '60%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/files.png')
```
...
```{r planilha, message = FALSE, echo = FALSE, fig.cap = "Planilha com os dados no formato *.csv que deve ser construída em algum editor de planilhas e salva na pasta de trabalho definida previamente", fig.align = "center", out.width = '80%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/planilha.png')
```

```{r planlhaxlsx, message = FALSE, echo = FALSE, fig.cap = "Planilha com os dados no formato *.xlsx que deve ser construída em algum editor de planilhas e salva na pasta de trabalho definida previamente", fig.align = "center", out.width = '80%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/planilhaxlsx.png')
```
...
```{r arqenv, message = FALSE, echo = FALSE, fig.cap = "Resultado da importação do arquivo observado na guia environment. Há um objeto de nome dados, com 40 observações e 4 variáveis.", fig.align = "center", out.width = '80%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/arqenv.png')
```


### Importar planilha via interface gráfica:
...
```{r import-graf, message = FALSE, echo = FALSE, fig.cap = "mudar a figura e fazer a legenda", fig.align = "center", out.width = '80%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/import-graf.png')
```
...
```{r import-graf-2, message = FALSE, echo = FALSE, fig.cap = "mudar a figura e fazer a legenda", fig.align = "center", out.width = '80%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/import-graf-2.png')
```
...
```{r abundancia, message = FALSE, echo = FALSE, fig.cap = "Planilha de dados de abundância.", fig.align = "center", out.width = '60%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/abundancia.png')
```
...
Repare que quando aplicamos a função `r colorize("summary()", "blue")` o R nos informou as variáveis presentes nestas planilhas e quando fator indicou quais são e quantos de cada existem e quando númerico nos retornou valores como média, mediana (segundo quartil), mínimo, máximo, primeiro e terceiro quartis.
...
```{r resumo1, message = FALSE, echo = FALSE, fig.cap = "Resumo dos passos abordados no capítulo: da definição do ambiente de trabalho até a sumarização dos dados. Com a indicação das funções mais importantes que devem e podem ser aplicadas para cada etapa.", fig.align = "center", out.width = '100%'}
knitr::include_graphics('/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/resumo1.png')
```
