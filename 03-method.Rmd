...
```{r resumo2, message = FALSE, echo = FALSE, fig.cap = "Resumo dos passos abordados no capítulo: da preparação dos dados até a análise dos dados.", fig.align = "center", out.width = '100%'}
