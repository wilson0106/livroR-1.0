...
\begin{figure}[H]
\includegraphics[width=1.1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/RStudio} \caption{Ambiente RStudio.}\label{fig:RStudio}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/script} \caption{Guia do RStudio referente ao ambiente onde o script será desenvolvido.}\label{fig:script}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/console} \caption{Guia do RStudio referente ao ambiente console onde o resultado dos comandos executados irão aparecer.}\label{fig:console}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/environment} \caption{Guia do RStudio referente ao ambiente environment, local onde estarão indicados os objetos criados.}\label{fig:environment}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/history} \caption{Guia do RStudio referente ao ambiente history onde estará listado todos os comandos executados.}\label{fig:history}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/files} \caption{Guia do RStudio referente ao ambiente files onde estará indicados os arquivos do nosso computador.}\label{fig:files}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/plot} \caption{Guia do RStudio referente ao ambiente plot onde estarão os gráficos criados.}\label{fig:plot}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/help} \caption{Guia do RStudio referente ao ambiente help onde terá informações sobre as funções e pacotes do R.}\label{fig:help}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.4\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/setwd} \caption{Janela que será aberta ao executar o comando: setwd(choose.dir()), no sistema operacional Windows.}\label{fig:setwd}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.5\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/files-guia} \caption{Guia *Files* indicando a opção para definir o local do computadors que será utilizado como ambiente de trabalho}\label{fig:files-guia}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.4\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/planilha} \caption{Planilha com os dados no formato *.csv que deve ser construída em algum editor de planilhas e salva na pasta de trabalho definida previamente}\label{fig:planilha}
\end{figure}

\begin{figure}[H]
\includegraphics[width=0.5\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/planilhaxlsx} \caption{Planilha com os dados no formato *.xlsx que deve ser construída em algum editor de planilhas e salva na pasta de trabalho definida previamente}\label{fig:planilhaxlsx}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/arqenv} \caption{Resultado da importação do arquivo observado na guia environment. Há um objeto de nome dados, com 40 observações e 4 variáveis.}\label{fig:arqenv}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/import-graf} \caption{mudar a figura e fazer a legenda}\label{fig:import-graf}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.8\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/import-graf-2} \caption{mudar a figura e fazer a legenda}\label{fig:import-graf-2}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/comp-hist-1} \caption{Comprimento dos organismos da planilha dados}\label{fig:comp-hist}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/comp-hist-col-1} \caption{Comprimento dos organismos da planilha dados com barras coloridas}\label{fig:comp-hist-col}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.4\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/abundancia} \caption{Planilha de dados de abundância.}\label{fig:abundancia}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-abu-1} \caption{Gráfico de barras com número de indivíduos da planilha abundância por mês}\label{fig:bar-abu}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-abu-col-1} \caption{Gráfico de barras com número de indivíduos da planilha abundância por mês, com barras coloridas}\label{fig:bar-abu-col}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/pon-graf-1} \caption{Representação gráfica do número de indivíduos por mês em pontos}\label{fig:pon-graf}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/lin-graf-col-1} \caption{Representação gráfica do número de indivíduos por mês em um gráfico de linhas}\label{fig:lin-graf-col}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/box-graf-1} \caption{Gráfico tipo boxplot do comprimento por ano, da planilha dados}\label{fig:box-graf}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/box-graf-col-1} \caption{Gráfico tipo boxplot do comprimento por ano com cores por ano, da planilha dados}\label{fig:box-graf-col}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-ep-1} \caption{Gráfico de barras com erro padrão do comprimento por ano e local, da planilha resultado (derivada da planilha dados)}\label{fig:bar-ep}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-ep-abu-1} \caption{Gráfico de barras com erro padrão da abundância por mês da planilha abundância}\label{fig:bar-ep-abu}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/resumo1} \caption{Resumo dos passos abordados no capítulo: da definição do ambiente de trabalho até a sumarização dos dados.}\label{fig:resumo1}
\end{figure}
...
## 
## data:  N.especies
## X-squared = 4, df = NA, p-value = 0.05947
\end{verbatim}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/resumo2} \caption{Resumo dos passos abordados no capítulo: da preparação dos dados até a análise dos dados.}\label{fig:resumo2}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-tam-cam-1} \caption{Histograma dos valores do objeto relativo ao tamanho dos camarões}\label{fig:hist-tam-cam}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/estrelas-hist-1} \caption{Histograma dos valores relativos a altura das estrelas do mar no costão rochoso}\label{fig:estrelas-hist}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/craca-hist-1} \caption{Histograma dos valores relativos ao tambanho das cracas incrustantes}\label{fig:craca-hist}
\end{figure}
...
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/cracas-dens-95-1} \textbackslash{}caption\{Curva de densidade representando o valor do teste-t bicaudal para o tamanho das cracas em relação a média teórica a um intervalo de confiança de 95\%. O ponto azul indica o valor do teste.\}\label{fig:cracas-dens-95}
...
\textbackslash{}begin\{figure\}{[}H{]}
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/cracas-dens-99-1} \textbackslash{}caption\{Curva de densidade representando o valor do teste-t bicaudal para o tamanho das cracas em relação a média teórica a um intervalo de confiança de 99\%. O ponto azul indica o valor do teste.\}\label{fig:cracas-dens-99}
\textbackslash{}end\{figure\}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-ali-A-1} \caption{Histograma com valores da mudança do peso dos gastrópodes após a dieta com o Alimento A}\label{fig:hist-ali-A}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-ali-B-1} \caption{Histograma com valores da mudança do peso dos gastrópodes após a dieta com o Alimento B}\label{fig:hist-ali-B}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/box-ali-1} \caption{Boxplot com os valores da alteração do peso dos gastrópodes por tipo de alimento}\label{fig:box-ali}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-temp-0-1} \caption{Histograma com valores de temperatura da lagoa no Ano 0.}\label{fig:hist-temp-0}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-temp-20-1} \caption{Histograma com valores de temperatura da lagoa no Ano 20.}\label{fig:hist-temp-20}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/box-temp-1} \caption{Boxplot com os valores de temperatura da lagoa por ano.}\label{fig:box-temp}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-par-obs1-1} \caption{Histograma com a frequência de observações de aves, por 20 dias, pelo observador 1}\label{fig:hist-par-obs1}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/hist-par-obs2-1} \caption{Histograma com a frequência de observações de aves, por 20 dias, pelo observador 2}\label{fig:hist-par-obs2}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/box-par-ave-1} \caption{Boxplot com as frequências de observações de aves por 20 dias de 2 observadores.}\label{fig:box-par-ave}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-dif-ave-1} \caption{Diferença entre o número de observações de aves, por dia, para cada observador}\label{fig:bar-dif-ave}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.7\linewidth]{livroR-1.0_files/figure-latex/bar-dif-ave2-1} \caption{Diferença entre o número de observações de aves, por dia, para cada observador.}\label{fig:bar-dif-ave2}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/figures print/resumo2} \caption{Resumo dos passos abordados no capítulo: da preparação dos dados até a análise dos dados.}\label{fig:resumo3}
\end{figure}
