...
{\centering \includegraphics[width=1\linewidth]{/media/wilson/personaldoc/Livro_R/Série estatística passo a passo em excel e R/livroR-1.0/docs/livroR-1.0_files/figures print/resumo1} 

}

\caption{Resumo dos passos abordados no capítulo: da definição do ambiente de trabalho até a sumarização dos dados. Com a indicação das funções mais importantes que devem e podem ser aplicadas para cada etapa.}\label{fig:resumo1}
\end{figure}
...
## 
## data:  N.especies
## X-squared = 4, df = NA, p-value = 0.06997
\end{verbatim}
