...
O comando \textbackslash{}textcolor\{blue\}\{\emph{read\_excel()}\} é similar ao \textcolor{blue}{*read.csv()*} embora seus argumentos sejam diferentes. O argumento path é similar ao file, o argumento col\_names é similar ao header. Repare que não temos o argumento sep, pois em um arquivo excel as variáveis são salvas em colunas diferentes.
...
## 
## data:  N.especies
## X-squared = 4, df = NA, p-value = 0.06847
\end{verbatim}
