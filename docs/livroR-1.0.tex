...
## 
## data:  N.especies
## X-squared = 4, df = NA, p-value = 0.06147
\end{verbatim}
...
Da mesma forma que avaliamos para o teste-t de uma amostra, podemos plotar o resultado como um gráfico da função de densidade do teste-t. Só devemos lembrar de carregar o pacote \textcolor{green}{webr}.
