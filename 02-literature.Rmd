...
```{r resumo1, message = FALSE, echo = FALSE, fig.cap = "Resumo dos passos do capítulo da importação da planilha até a sumarização gráfica e númerica.", fig.align = "center", out.width = '100%'}
